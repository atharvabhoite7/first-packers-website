...
const EnquiryForm = () => {
  return (
    <form class="rounded-lg shadow-xl flex flex-col px-8 py-8 bg-white dark:bg-white">
      ...
      <label
        for="fullname"
        class="text-gray-500 font-light mt-8 dark:text-blackpy-2 mb-2"
      >
      ...
      <input
        type="text"
        name="fullname"
        class="bg-transparent border-b py-2 pl-4 focus:outline-none focus:rounded-md focus:ring-1 ring-black-500 font-light text-black"
        required
      />

      <label
        for="email"
        class="text-gray-500 font-light mt-4 dark:text-black py-2"
      >
