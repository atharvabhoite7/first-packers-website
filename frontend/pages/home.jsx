          ...
          <div className="text-center">
            ...
            <div className="text-center">
              <p className="font-semi-bold text-lg text-gray-700">
                ...
                years, always delivering stellar results to all clients. The venture started with the aim to satisfy cients and make the process of shifting homes and offices easier and hassle-free. 
                Here is the Man Behind the Show! Get to know the visionary who started it all,
